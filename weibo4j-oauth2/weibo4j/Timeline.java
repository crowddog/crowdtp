...
//	public StatusWapper getFriendsTimeline(int count, int baseApp) throws WeiboException {
//		return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "status/friends_timeline.json",
//			new PostParameter[] {
//					new PostParameter("count", count),
//					new PostParameter("base_app", baseApp)}));
//	}
